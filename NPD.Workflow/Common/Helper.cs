namespace System.Web.Mvc.Html
{
    ...
    public static class Helper
    {
        ...
        /// </summary>
        private static readonly string[] _validExtensions = { "avi", "pdf", "doc", "docx", "msg", "xls", "xlsx", "csv", "txt", "rtf", "html", "zip", "rar", "mp3", "wma", "mpg", "flv", "jpg", "jpeg", "png", "gif", "ppt", "pptx", "txt" }; //  etc
