...
namespace NPD.Workflow.Models.NPD
{
    public class NPDABSAdminSection : ISection
    {
        ...
        public NPDABSAdminSection(bool isSet)
        {
            if (isSet)
            {
                this.ListDetails = new List<ListItemDetail>() { new ListItemDetail(NPDListNames.NPDLIST, true) };
                this.SectionName = NPDSectionName.NPDABSADMINSECTION;
