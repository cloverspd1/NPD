...
{
    public class NPDApprover1Section : ISection
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NPDApprover1Section"/> class.
        /// </summary>
        public NPDApprover1Section()
        {
        }
        ...
        public NPDApprover1Section(bool isSet)
        {
            if (isSet)
            {
                this.ListDetails = new List<ListItemDetail>() { new ListItemDetail(NPDListNames.NPDLIST, true) };
                this.SectionName = NPDSectionName.NPDAPPROVER1SECTION;
