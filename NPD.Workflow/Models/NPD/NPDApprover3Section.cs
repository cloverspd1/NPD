...
{
    public class NPDApprover3Section : ISection
    {
         /// <summary>
        /// Initializes a new instance of the <see cref="NPDApprover3Section"/> class.
        /// </summary>
        public NPDApprover3Section()
        {
        }
        ...
        public NPDApprover3Section(bool isSet)
        {
            if (isSet)
            {
                this.ListDetails = new List<ListItemDetail>() { new ListItemDetail(NPDListNames.NPDLIST, true) };
                this.SectionName = NPDSectionName.NPDAPPROVER3SECTION;
