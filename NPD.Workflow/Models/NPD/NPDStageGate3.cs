...
{
    public class NPDStageGate3 : ISection
    {
        public NPDStageGate3()
        {
        }
        ...
        /// </value>
        [DataMember]
        public string StageGate3Attachment { get; set; }
    }
}