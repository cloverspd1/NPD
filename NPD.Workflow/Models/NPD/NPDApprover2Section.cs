...
{
    public class NPDApprover2Section : ISection
    {
         /// <summary>
        /// Initializes a new instance of the <see cref="NPDApprover2Section"/> class.
        /// </summary>
        public NPDApprover2Section()
        {
        }
        ...
        public NPDApprover2Section(bool isSet)
        {
            if (isSet)
            {
                this.ListDetails = new List<ListItemDetail>() { new ListItemDetail(NPDListNames.NPDLIST, true) };
                this.SectionName = NPDSectionName.NPDAPPROVER2SECTION;
