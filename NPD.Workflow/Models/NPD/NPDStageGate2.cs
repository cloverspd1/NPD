...
{
    public class NPDStageGate2 : ISection
    {
        public NPDStageGate2()
        {
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="NPDABSAdminSection"/> class.
        /// </summary>
        /// <param name="isSet">if set to <c>true</c> [is set].</param>
        public NPDStageGate2(bool isSet)
        {
            if (isSet)
            {
                this.ListDetails = new List<ListItemDetail>() { new ListItemDetail(NPDListNames.NPDLIST, true) };
                this.SectionName = NPDSectionName.NPDSTAGEGATE2SECTION;
        ...
        /// </value>
        [DataMember]
        public string StageGate2Attachment { get; set; }
    }
}