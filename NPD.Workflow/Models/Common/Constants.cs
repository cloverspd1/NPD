...
namespace NPD.Workflow.Models.Common
{
    ...
    public static class Masters
    {
        ...
        /// <summary>
        /// The testsampletypesmaster
        /// </summary>
        public const string TESTSAMPLETYPESMASTER = "TestSampleTypesMaster";

        /// <summary>
        /// The lightsourcemaster
        /// </summary>
        public const string LIGHTSOURCEMASTER = "LightSourceMaster";


        /// <summary>
        /// The drivertypemaster
        /// </summary>
        public const string DRIVERTYPEMASTER = "DriverTypeMaster";
    }
