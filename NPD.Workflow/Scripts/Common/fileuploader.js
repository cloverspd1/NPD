...
qq.FileUploaderBasic = function (o) {
    this._options = {
        ...
        maxFiles: 10,
        // validation        
        allowedExtensions: [ "doc", "docx", "msg", "xls", "xlsx", "csv", "txt", "rtf", "html", "zip", "rar", "mp3", "wma", "mpg", "flv", "avi", "jpg", "jpeg", "png", "gif", "ppt", "pptx", "txt"],
        sizeLimit: 0,
        minSizeLimit: 0,
        duplicateCheck: true,
        // events
...
qq.FileUploaderBasic.prototype = {
    ...
    _isAllowedExtension: function (fileName) {
        ...
        var allowedExtension1 = ["avi", "pdf", "doc", "docx", "msg", "xls", "xlsx", "csv", "txt", "zip", "jpg", "jpeg", "png", "gif", "ppt", "pptx"];
